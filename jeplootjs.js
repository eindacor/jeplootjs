...
JepLoot.prototype.booRoll = function(chance) {
	try {
...
JepLoot.prototype.numRoll = function(min, max) {
	try {
		if (max <= min)
...
JepLoot.prototype.intRoll = function(min, max) {
	try {
		if (max <= min)
			throw "minimum value must be less than maximum value";
...
JepLoot.prototype.catRoll = function(categories) {
	try {
		var seed_range = 0;
		var ranges = {};
